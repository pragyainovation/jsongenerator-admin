...
module.exports = {
  content: ['./components/**/*.{js,ts,jsx,tsx,mdx}', './constant/**/*.{js,ts,jsx,tsx,mdx}', './icon/**/*.{js,ts,jsx,tsx,mdx}', './pages/**/*.{js,ts,jsx,tsx,mdx}', './app/**/*.{js,ts,jsx,tsx,mdx}', './shared/**/*.{js,ts,jsx,tsx,mdx}', './widgets/**/*.{js,ts,jsx,tsx,mdx}'],
  theme: {
    extend: {
      colors: {
