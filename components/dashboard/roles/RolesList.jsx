  ...
  return (
    ...
    >
      ...
      <DialogBox isOpen={openDialog} onClose={() => (loaderHandler(isLoading) ? {} : setOpenDialog(null))}>
        {openDialog === BUTTON.EDIT && <ConfirmationBox openDialog={openDialog} isLoading={isLoading} itemName={data?.roleData?.roleName} buttonClick={() => (openDialog ? handleConfirm(openDialog) : undefined)} />}
      </DialogBox>
